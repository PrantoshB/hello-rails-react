...
```sh
 git clone https://github.com/prantoshb/hello-rails-react.git
```
...
This project is [MIT](https://github.com/prantoshb/hello-rails-react/blob/rails-react/MIT.md) licensed.
